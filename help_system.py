...
def _build_owner_help_text(expanded: bool = False) -> str:
    ...
    return (
        ...
        "/lockbot on\\|off \\- Global emergency switch \\- `on` blocks every command "
        "and button click from anyone except owners \\(they get an explicit notice, not silence\\)\\. "
        "Going/Not Going/ADD/Drop/ALL on an already\\-posted event still work for everyone\\.\n"
    ...
    help_sections = {
        ...
        "help_utility": (
            ...
            + (
                ...
                "or omitted for all time\\; buttons under the reply also switch periods"
